"""
Philox 4x32 RNG — imitates torch CUDA randn on CPU.

Vendored from ComfyUI_smZNodes (shiimizu/ComfyUI_smZNodes).
...
def uint32(x):
    """Converts (N,) np.uint64 array into (2, N) np.uint32 array."""
...
def philox4_32(counter, key, rounds=10):
    """Generates 32-bit random numbers using the Philox 4x32 RNG."""
...
def box_muller(x, y):
    """Box-Muller transform: returns the first of two normal variates."""
